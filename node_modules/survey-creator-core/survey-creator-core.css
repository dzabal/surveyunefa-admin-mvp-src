...
.svc-creator {
  ...
  --sjs-primary-foreground-25: rgba(from var(--sjs2-color-fg-static-main-primary) r g b / 0.25);
  ...
  --sjs-special-background: var(--sjs2-color-utility-surface-designer);
...
.svc-creator-popup,
.svc-creator {
  --ctr-font-unit: var(--sjs2-base-unit-font-size, 8px);
  --ctr-line-height-unit: var(--sjs2-base-unit-line-height, 8px);
  --ctr-size-unit: var(--sjs2-base-unit-size, 8px);
  --ctr-spacing-unit: var(--sjs2-base-unit-spacing, 8px);
  --ctr-corner-radius-unit: var(--sjs2-base-unit-radius, 8px);
  --ctr-stroke-unit: var(--sjs2-base-unit-border-width, 1px);
}
...
.svc-menu-action__button.svc-menu-action__button--disabled use {
  opacity: var(--ctr-toolbox-item-icon-opacity-disabled, 0.25);
  fill: var(--ctr-toolbox-item-icon-color-disabled, var(--sjs-layer-1-foreground-100, rgba(0, 0, 0, 0.9019607843)));
}
...
.spg-question--location--left:focus-within .spg-question__content--left {
  box-shadow: inset calc(-1 * var(--ctr-editor-border-width-focused, var(--sjs-stroke-x2))) 0 0 0 var(--ctr-editor-border-color-focused, var(--sjs-primary-background-500, #19b394)), inset 0 calc(var(--ctr-editor-border-width-focused, var(--sjs-stroke-x2))) 0 0 var(--ctr-editor-border-color-focused, var(--sjs-primary-background-500, #19b394)), inset 0 calc(-1 * var(--ctr-editor-border-width-focused, var(--sjs-stroke-x2))) 0 0 var(--ctr-editor-border-color-focused, var(--sjs-primary-background-500, #19b394));
}
.spg-question--location--left:focus-within .spg-question__header--location--left {
  box-shadow: inset calc(var(--ctr-editor-border-width-focused, var(--sjs-stroke-x2))) 0 0 0 var(--ctr-editor-border-color-focused, var(--sjs-primary-background-500, #19b394)), inset 0 calc(var(--ctr-editor-border-width-focused, var(--sjs-stroke-x2))) 0 0 var(--ctr-editor-border-color-focused, var(--sjs-primary-background-500, #19b394)), inset 0 calc(-1 * var(--ctr-editor-border-width-focused, var(--sjs-stroke-x2))) 0 0 var(--ctr-editor-border-color-focused, var(--sjs-primary-background-500, #19b394));
}
.spg-question--location--left.spg-question--disabled .spg-question__content--left {
  background-color: var(--ctr-editor-background-color-disabled, var(--sjs-layer-1-background-500, white));
}
.spg-question--location--left.spg-question--disabled .spg-question__header--location--left {
  background-color: var(--ctr-editor-background-color-disabled, var(--sjs-layer-1-background-500, white));
}
...
.spg-question__header--location--left {
  ...
  box-sizing: border-box;
  box-shadow: inset calc(var(--ctr-editor-border-width, var(--sjs-stroke-x1))) 0 0 0 var(--ctr-editor-border-color, var(--sjs-border-10, gainsboro)), inset 0 calc(var(--ctr-editor-border-width, var(--sjs-stroke-x1))) 0 0 var(--ctr-editor-border-color, var(--sjs-border-10, gainsboro)), inset 0 calc(-1 * var(--ctr-editor-border-width, var(--sjs-stroke-x1))) 0 0 var(--ctr-editor-border-color, var(--sjs-border-10, gainsboro));
}
...
.spg-question__content--left {
  ...
  background: var(--ctr-editor-background-color, var(--sjs-layer-3-background-500, #f4f4f4));
  box-shadow: inset calc(-1 * var(--ctr-editor-border-width, var(--sjs-stroke-x1))) 0 0 0 var(--ctr-editor-border-color, var(--sjs-border-10, gainsboro)), inset 0 calc(var(--ctr-editor-border-width, var(--sjs-stroke-x1))) 0 0 var(--ctr-editor-border-color, var(--sjs-border-10, gainsboro)), inset 0 calc(-1 * var(--ctr-editor-border-width, var(--sjs-stroke-x1))) 0 0 var(--ctr-editor-border-color, var(--sjs-border-10, gainsboro));
}
...
.spg-tagbox__value .sv-tagbox__item {
  ...
  box-shadow: inset 0 0 0 var(--ctr-tag-box-item-border-width, var(--sjs-stroke-x1)) var(--ctr-tag-box-item-border-color, var(--sjs-border-10, #d4d4d4));
...
.spg-tagbox-item_clean-button {
  --ctr-tag-box-item-mask-color-2: rgba(from var(--sjs-layer-1-background-500) r g b / 0.4);
  background: linear-gradient(270deg, var(--ctr-tag-box-item-mask-color-1, var(--sjs-layer-1-background-500, #ffffff)) 50%, var(--ctr-tag-box-item-mask-color-2, var(--sjs-layer-3-background-500, rgba(255, 255, 255, 0.2509803922))) 100%);
}
