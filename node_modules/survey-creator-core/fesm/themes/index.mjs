...
const __surveyjs_internal_configs_hash = true;
var index = { SC2020, DefaultLight, DefaultDark, DefaultContrast, __surveyjs_internal_configs_hash };

export { DefaultContrast, DefaultDark, DefaultLight, SC2020, __surveyjs_internal_configs_hash, index as default };
