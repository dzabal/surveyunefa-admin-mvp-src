...
export declare class Translation extends Base implements ITranslationLocales {
    ...
    getMachineTranslationFromLocale?: () => string | undefined;
    setMachineTranslationFromLocale?: (locale: string) => void;
    private surveyValue;
    ...
    private getOrderedLocales;
    private ensureSelectedLocale;
    private isDefaultLocaleSelected;
    private getOrderedLocaleNames;
...
export declare class TranslationEditor {
    ...
    private getInitialFromLocale;
    private isValidFromLocale;
    ...
    private get isDefaultLocaleTarget();
    private getFromLocaleItems;
