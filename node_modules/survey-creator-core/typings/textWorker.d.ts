import { SurveyModel, JsonError, Base, ILoadFromJSONOptions } from "survey-core";
...
export declare class SurveyTextWorker {
    text: string;
    private options?;
    static onProcessJson: ((json: any) => void) | undefined;
    static newLineChar: string;
    errors: Array<SurveyTextWorkerError>;
    private surveyValue;
    private jsonValue;
    constructor(text: string, options?: ILoadFromJSONOptions);
