import { ILocalizableOwner } from "survey-core";
...
export declare function applyCreatorUiLocaleToPopup(popup: {
    locale?: string;
    contentComponentData?: any;
}, locOwner: ILocalizableOwner): void;
...
export declare var defaultStrings: {
    ...
    ed: {
        ...
        expressionUnknownFunction: string;
        expressionUnknownFunctions: string;
        expressionUnknownVariable: string;
        expressionUnknownVariables: string;
        expressionSyntaxError: string;
        expressionSemanticsError: string;
        toolbox: string;
        toolboxSearch: string;
        toolboxFilteredTextPlaceholder: string;
        toolboxNoResultsFound: string;
        propertyGridEmptySurveyText: string;
    ...
    pe: {
        ...
        imagemap: {
            ...
            maxSelectedAreas: string;
            minSelectedAreas: string;
        };
        imagemaparea: {
            value: string;
            shape: string;
