...
export declare class SurveyCreatorModel extends Base implements ISurveyCreatorOptions, ICreatorSelectionOwner, ILocalizableOwner {
    ...
    private getUnlicensedPluginsNames;
    ...
    getPlugin<P extends ICreatorPlugin = ICreatorPlugin>(name: string, create?: boolean): P;
     ...
     * @since 2.5.33
     */
    onBeforeShowInplaceDescriptionEditor: EventBase<SurveyCreatorModel, BeforeShowInplaceDescriptionEditorEvent>;
    /**
     ...
     * @since 2.3.8
     */
    onAllowAddElement: EventBase<SurveyCreatorModel, AllowAddElementEvent>;
    /**
     ...
     */
    onCollectionItemDeleting: EventBase<SurveyCreatorModel, CollectionItemDeletingEvent>;
    /**
    ...
    onClearFile: EventBase<SurveyCreatorModel, UploadFileEvent>;
    /**
     ...
     * @since 2.3.14
     */
    get showObjectTitles(): boolean;
    set showObjectTitles(val: boolean);
    /**
     * @deprecated Use the [`useElementTitles`](https://surveyjs.io/survey-creator/documentation/api-reference/survey-creator#useElementTitles) property instead.
     * @since 2.3.14
     */
    get showTitlesInExpressions(): boolean;
    set showTitlesInExpressions(val: boolean);
    /**
    ...
    get tabResponsivenessMode(): string;
    set tabResponsivenessMode(val: string);
    tabbedMenu: TabbedMenuContainer;
    private pluginMenuHash;
    private pluginTabs;
    ...
    updateLocalizedStrings(refreshPlugin?: boolean): void;
    locStrsChanged(): void;
    ...
    get activeTabMenuItem(): TabbedMenuItem;
    ...
    */
    ...
    private addPluginFooterActions;
    private removePluginFooterActions;
    ...
    private isCreatingNewElement;
    private doOnQuestionAdded;
    onElementTypeRestrictionChanged: EventBase<SurveyCreatorModel, any>;
    private doOnElementsChanged;
    private isToolboxItemDisabledByRestriction;
    ...
    focusElement(element: any, focus: string | boolean, selEl?: any, propertyName?: string, startEdit?: boolean, onCallback?: () => void): void;
    private focusElementCore;
    scrollToElement(elementPage: PageModel, selEl: any, el: HTMLElement): void;
    private getChoiceItemQuestionToExpand;
    ...
    clearFiles(value: any, question: Question, callback: (status: string, data: any) => any, context?: {
        element: Base;
        item?: any;
        elementType?: string;
        propertyName?: string;
    ...
    private defaultAddQuestionTypeValue;
    get defaultAddQuestionType(): string;
    set defaultAddQuestionType(val: string);
    ...
    private patchLegacyCSSVariables;
