...
:dir(rtl) .sv-ranking,
[style*="direction:rtl"] .sv-ranking,
[style*="direction: rtl"] .sv-ranking {
  transform: scale(-1, 1);
  direction: ltr;
}
:dir(rtl) .sv-ranking-item__text,
:dir(rtl) .sv-ranking__container-placeholder,
:dir(rtl) .sd-ranking-item__index,
[style*="direction:rtl"] .sv-ranking-item__text,
[style*="direction:rtl"] .sv-ranking__container-placeholder,
[style*="direction:rtl"] .sd-ranking-item__index,
[style*="direction: rtl"] .sv-ranking-item__text,
[style*="direction: rtl"] .sv-ranking__container-placeholder,
[style*="direction: rtl"] .sd-ranking-item__index {
  transform: scale(-1, 1);
...
.sd-input[type=time]:not(.sd-input--value-changed),
.sd-input[type=date]:not(.sd-input--value-changed),
.sd-input[type=datetime-local]:not(.sd-input--value-changed),
.sd-input[type=week]:not(.sd-input--value-changed),
.sd-input[type=month]:not(.sd-input--value-changed) {
  color: var(--sjs-general-forecolor-light, var(--foreground-light, #909090));
}
...
.sd-dropdown--empty.sd-input--readonly {
  justify-content: flex-end;
}
...
.sd-body__navigation {
  box-sizing: border-box;
  padding: calc(4 * (var(--sjs-base-unit, var(--base-unit, 8px)))) calc(5 * (var(--sjs-base-unit, var(--base-unit, 8px))));
  flex-wrap: wrap;
  gap: calc(2 * (var(--sjs-base-unit, var(--base-unit, 8px))));
}
...
.sv-components-container-contentTop .sd-body__navigation {
  padding-top: 0;
}
...
.sd-body.sd-body--responsive {
  max-width: initial;
  padding: calc(5 * (var(--sjs-base-unit, var(--base-unit, 8px)))) calc(5 * (var(--sjs-base-unit, var(--base-unit, 8px)))) var(--sjs-base-unit, var(--base-unit, 8px));
  box-sizing: border-box;
}
...
.sd-root-modern--mobile .sd-body.sd-body--responsive .sv-components-container-contentBottom .sd-body__navigation, .sd-root-modern--mobile .sd-body.sd-body--static .sv-components-container-contentBottom .sd-body__navigation {
  padding-bottom: 0;
}
.sd-root-modern--mobile .sd-body.sd-body--responsive .sv-components-container-contentTop .sv-header ~ .sd-body__navigation, .sd-root-modern--mobile .sd-body.sd-body--static .sv-components-container-contentTop .sv-header ~ .sd-body__navigation {
  padding-top: calc(4 * (var(--sjs-base-unit, var(--base-unit, 8px))));
}
.sd-root-modern--mobile .sd-body.sd-body--responsive .sv-components-container-contentTop .sd-body__navigation, .sd-root-modern--mobile .sd-body.sd-body--static .sv-components-container-contentTop .sd-body__navigation {
  padding-top: 0;
}
...
.sd-root--compact .sd-body.sd-body--responsive .sv-components-container-contentTop .sd-body__navigation, .sd-root--compact .sd-body.sd-body--static .sv-components-container-contentTop .sd-body__navigation {
  padding-top: 0;
}
...
.sd-root-modern--mobile .sd-progress-buttons__list li:not(:first-child) > .sd-progress-buttons__connector,
.sd-progress-buttons--no-titles .sd-progress-buttons__list li:not(:first-child) > .sd-progress-buttons__connector {
  bottom: calc(50% - 1px);
  right: auto;
  width: calc((100% - 20px * var(--sd-progress-buttons-pages-count)) / (var(--sd-progress-buttons-pages-count) - 1));
  transform: translatex(-100%);
}

.sd-progress-buttons--no-titles.sd-progress-buttons--numbered .sd-progress-buttons__list li:not(:first-child) > .sd-progress-buttons__connector,
.sd-root-modern--mobile .sd-progress-buttons--numbered .sd-progress-buttons__list li:not(:first-child) > .sd-progress-buttons__connector {
  width: calc((100% - 36px * var(--sd-progress-buttons-pages-count)) / (var(--sd-progress-buttons-pages-count) - 1));
}
...
:dir(rtl) .sd-root-modern--mobile .sd-progress-buttons__list li:not(:first-child) > .sd-progress-buttons__connector,
:dir(rtl) .sd-progress-buttons--no-titles .sd-progress-buttons__list li:not(:first-child) > .sd-progress-buttons__connector,
[style*="direction:rtl"] .sd-root-modern--mobile .sd-progress-buttons__list li:not(:first-child) > .sd-progress-buttons__connector,
[style*="direction:rtl"] .sd-progress-buttons--no-titles .sd-progress-buttons__list li:not(:first-child) > .sd-progress-buttons__connector,
[style*="direction: rtl"] .sd-root-modern--mobile .sd-progress-buttons__list li:not(:first-child) > .sd-progress-buttons__connector,
[style*="direction: rtl"] .sd-progress-buttons--no-titles .sd-progress-buttons__list li:not(:first-child) > .sd-progress-buttons__connector {
  transform: translateX(100%);
}
