...
export declare class DropdownListModel extends Base {
    ...
    private isListFocusedByKeyboard;
    ...
    private surveyPropertyChangedHandler;
    ...
    private static readonly KEY_UP;
    private static readonly KEY_DOWN;
    private static readonly KEY_TAB;
    private static readonly KEY_ENTER;
    private static readonly KEY_ESCAPE;
    private static readonly KEY_SPACE;
    private static readonly KEY_DELETE;
    private static readonly KEY_BACKSPACE;
