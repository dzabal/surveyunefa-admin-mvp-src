...
import type { MatrixDropdownRowModelBase, QuestionMatrixDropdownModelBase } from "../question_matrixdropdownbase";
...
import type { ISurveyElementLifecycle, ISurveyFileCallbacks, ISurveyMatrixCallbacks, ISurveyDynamicPanelCallbacks, ISurveyChoiceCallbacks, ISurveyCssCallbacks, ISurveyAfterRenderCallbacks } from "./survey-callbacks";
...
export interface ISurvey extends ITextProcessor, ISurveyErrorOwner, ISurveyElementLifecycle, ISurveyFileCallbacks, ISurveyMatrixCallbacks, ISurveyDynamicPanelCallbacks, ISurveyChoiceCallbacks, ISurveyCssCallbacks, ISurveyAfterRenderCallbacks, ISurveyTitleSettings, ISurveyValidation, ISurveySingleInput {
    currentPage: IPage;
    activePage: IPage;
    pages: Array<IPage>;
