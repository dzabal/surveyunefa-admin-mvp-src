...
import { ActionBarCssClasses } from "./actionBarCss";
...
export declare function setCreatePopupModelWithListModel(fn: (listOptions: IListModel, popupOptions?: IPopupOptionsBase) => PopupModel): void;
