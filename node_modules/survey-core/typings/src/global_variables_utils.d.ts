export declare class DomWindowHelper {
    ...
    static isEventListenerAvailable(): boolean;
    static addEventListener(type: string, listener: (e?: any) => void, options?: boolean | AddEventListenerOptions): void;
    static removeEventListener(type: string, listener: (e?: any) => void, options?: boolean | EventListenerOptions): void;
    static matchMedia(mediaQueryString: string): {
        matches: boolean;
    } | null;
    static getScreenOrientationType(): string | undefined;
}
