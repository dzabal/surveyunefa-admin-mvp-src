...
export declare class JsonObjectProperty implements IObject, IJsonPropertyInfo {
    ...
    validateValue(obj: Base, value: any): boolean;
...
export declare class JsonMetadata {
     ...
     * @since 2.5.34
     */
    setAlias(type: string, alias: string): void;
    /**
     ...
     * @since 2.5.34
     */
    getTypeByAlias(alias: string): string;
    /**
     ...
     * @since 2.5.34
     */
    getAliasByType(type: string): string;
    /**
